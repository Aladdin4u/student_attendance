...
class DepartmentDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('Edit', function (Department $dept) {
                return '<a href="/departments/' . $dept->id . '/edit"><button>
            ...
            ->addColumn('Delete', function (Department $dept) {
                return '<form method="POST" action="/departments/' . $dept->id . '">
                ' . csrf_field() . '
                ' . method_field("DELETE") . '
                <button>
