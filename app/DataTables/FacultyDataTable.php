...
class FacultyDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('Edit', function (Faculty $faculty) {
                return '<a href="/faculties/' . $faculty->id . '/edit"><button>
            ...
            ->addColumn('Delete', function (Faculty $faculty) {
                return '<form method="POST" action="/faculties/' . $faculty->id . '">
                ' . csrf_field() . '
                ' . method_field("DELETE") . '
                <button>
