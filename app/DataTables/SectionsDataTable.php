...
class SectionsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('Edit', function (Section $section) {
                return '<a href="/sections/' . $section->id . '/edit"><button>
            ...
            ->addColumn('Delete', function (Section $section) {
                return '<form method="POST" action="/sections/' . $section->id . '">
                ' . csrf_field() . '
                ' . method_field("DELETE") . '
                <button>
