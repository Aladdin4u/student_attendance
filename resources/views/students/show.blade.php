<x-layout>
  ...
  <div class="w-full p-5 text-gray-900 bg-white dark:text-white dark:bg-gray-800 rounded-lg">
    ...
    <div class="w-full flex items-center justify-between">
      ...
      <button class="flex justify-center rounded-md bg-sky-400 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400">Register Course</button>
    </div>
    ...
    <form method="POST" action="/students/courses" class="mb-4">
      @csrf
      <div>
        <label for="course_id">Course registration</label>
