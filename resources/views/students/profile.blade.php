  ...
  <div class="w-full p-5 text-gray-900 bg-white dark:text-white dark:bg-gray-800 rounded-lg space-y-4">
    ...
    <div class="space-y-2 mt-10">
      ...
      <div class="w-full mt-10">
        ...
        <p class="font-semibold text-sky-500">OtherName Name: <span class="text-gray-900">{{$student->otherName}}</span></p>
    ...
    <div class="space-y-2">
      <div class="flex items-center justify-between">
        ...
        <a href="#" class="rounded-md bg-sky-400 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400">Edit course</a>
      </div>
