<x-layout>
    ...
    <form method="POST" action="/students">
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="otherName" placeholder="Other Names" value="{{old('otherName')}}" />
            @error('otherName')
            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="regNumber" placeholder="Registration Number" value="{{old('regNumber')}}" />
            @error('regNumber')
            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="level" placeholder="Level" value="{{old('level')}}" />
            @error('level')
            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            <button class="bg-blue-500 text-white rounded py-2 px-4 hover:bg-blue-600">
                Save
            </button>
