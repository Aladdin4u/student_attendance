<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li x-data="{ open: false }" x-init=" {{ request()->is('users*')}} ? open = true : open = false ">
            ...
            <li x-data="{ open: false }" x-init=" {{ request()->is('students*')}} ? open = true : open = false ">
                <div x-on:click="open = ! open" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-sky-100 hover:text-sky-500 dark:hover:bg-sky-700 group">
                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-sky-500 dark:group-hover:text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <li x-data="{ open: false }" x-init=" {{ request()->is('courses*')}} ? open = true : open = false ">
                <div x-on:click="open = ! open" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-sky-100 hover:text-sky-500 dark:hover:bg-sky-700 group">
                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-sky-500 dark:group-hover:text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="space-y-2 font-medium pl-10" x-show="open">
                    ...
                    <li><a href="/courses/manage" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:text-sky-500 hover:bg-sky-100 {{ request()->is('courses/manage') ? 'bg-sky-100 text-sky-500' : ''}} {{ request()->is('courses/*') ? 'bg-sky-100 text-sky-500' : ''}}">View All Courses</a></li>
                </ul>
            </li>
            @else
            <li>
            ...
            <li x-data="{ open: false }">
                ...
                <ul class="space-y-2 font-medium pl-10" x-show="open" x-init=" {{ request()->is('attendances*')}} ? open = true : open = false ">
                    ...
                    <li><a href="/attendances/*" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:text-sky-500 hover:bg-sky-100">View Students Attendance</a></li>
